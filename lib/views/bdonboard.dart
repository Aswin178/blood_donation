...
import 'package:blood_donation/views/landing.dart';
          ...
          Center(
            child: DotsIndicator(
              ...
              decorator: DotsDecorator(
                color: bdprimaryclr.withOpacity(0.4),
                size: const Size.square(8.0),
                activeSize: const Size(20.0, 8.0),
                activeShape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(5),
                ),
                activeColor: bdprimaryclr,
              ),
            ),
          ),
...
List<OnBoarding> onBoardinglist = [
  OnBoarding(
    title: 'Be a Hero:Start Your Blood Donation Adventure',
    image: ImagePath.onboard1,
    description:
        'The essential language learning tools and resources you  new language',
  ),
  OnBoarding(
      title: "Saving Lives: It's In Your Blood",
      image: ImagePath.onboard2,
      description:
          'Engaging features including test, story telling, re language learners to unlock their full potential'),
  OnBoarding(
      title: "Every Drop Counts.Every Donor Matters",
      image: ImagePath.onboard3,
      description:
          'Updated TalkGpt with premium materials and a dedicated following,'),
];
